...
const MentionableProjects = () => {
    const projectsData = [
        ...
        },
        {
            ...
            projectDesc: "Trusty furniture is a simple ecommerce web application where  people can purchase various kinds of furniture like table,  chair, sofa and so on. People can easily add product to cart and see their ordered  products with the total price.",
            tech1: 'Redux',
            tech2: 'React JS',
            tech3: 'React Router',
            projectImg: Redux,
